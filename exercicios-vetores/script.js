...
console.log("A sua soma é " + soma + "\nSua média: " + media + "\nO total de números maiores que a média são: " + total);         // CONCLUÍDO
...
console.log(v.reverse());                                               // CONCLUÍDO
