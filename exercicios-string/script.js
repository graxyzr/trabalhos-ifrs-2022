...
if (dc.length == 10 && dc.charAt(2) == "/" || dc.charAt(2) == "-" || dc.charAt(2) == "." && dc.charAt(5) == "/" || dc.charAt(5) == "-" || dc.charAt(5) == ".") {
    ...
    alert("O formato da data é válido!");
        ...
        if (m == 01 || m == 02 || m == 03 || m == 04 || m == 05 || m == 06 || m == 07 || m == 08 || m == 09 || m == 10 || m == 11 || m == 12) {

            alert("O mês da data é válido!");
        ...
        if (d >= 01 && d <= 31 || d <= 30 || d <= 28) {
            
            alert("O dia da data é válido!");
